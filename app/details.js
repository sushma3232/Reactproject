export  const movies = [{
    ...
    id: 1, 
    name: 'Bahubali',
    duration: '2015 Indian Telugu-language epic action film co-written and directed by S. S. Rajamouli, and produced by Shobu Yarlagadda and Prasad Devineni under Arka Media Works.',
    description: 'Prabhas',
    ...
    id: 4, 
    name: 'Salaar',
    description: 'Salaar (also marketed as Salaar: The Saga) is an upcoming Indian Telugu-language action thriller film written and directed by Prashanth Neel, and produced by Vijay Kiragandur under Hombale Films.',
    ...
    id: 5, 
    name: 'Majili',
    description: 'The film stars Samantha Ruth Prabhu, Naga Chaitanya and Divyansha Kaushik, with Subbaraju, Rao Ramesh, and Atul Kulkarni in supporting roles.',
    duration:'2h 30min',
    ...
    id: 6, 
    name: 'Fidaa',
    description: 'Fidaa ( transl. Spellbound) is a 2017 Indian Telugu-language romantic comedy film written and directed by Sekhar Kammula, and produced by Dil Raju under Sri Venkateswara Creations banner',
    duration:'2h 30min',
    ...
    id: 7, 
    name: 'Love story',
    description: 'Love Story is a 2021 Indian Telugu-language musical romantic-drama film written and directed by Sekhar Kammula.',
    duration:'2h 30min',
    ...
    id: 8, 
    name: 'Stalin',
    description: 'Stalin is a 2006 Indian Telugu-language action political drama film directed by A. R. Murugadoss. ',
    duration:'2h 30min',
    ...
    id: 9, 
    name: 'Adhuri',
    description: 'Addhuri is a 2012 Kannada romantic drama film starring Dhruva Sarja in his debut film, along with Radhika Pandit in the lead roles. The story, screenplay .',
    duration:'2h 30min',
